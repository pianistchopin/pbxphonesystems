...
namespace Amasty\Xsearch\Plugin\View\Page\Config;
...
class Renderer
{
    const CACHE_KEY = 'amasty_xsearch_should_load_css_file';
    ...
    public function beforeRenderAssets(
        ...
        if ($shouldLoad) {
            $this->config->addPageAsset('Amasty_Xsearch::css/source/mkcss/am-xsearch.css');
        }
