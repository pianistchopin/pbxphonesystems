...
/**
 * Class UpgradeSchema
 * @package Amasty\ElasticSearch\Setup
 */
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    /**
     * @var Operation\CreateStemmedWordsScheme
     */
    private $createStemmedWordsScheme;

    public function __construct(
        Operation\ChangeRelevanceRuleTableRelation $changeRelevanceRuleTableRelation,
        Operation\CreateStemmedWordsScheme $createStemmedWordsScheme
    ) {
        $this->changeRelevanceRuleTableRelation = $changeRelevanceRuleTableRelation;
        $this->createStemmedWordsScheme = $createStemmedWordsScheme;
    }
    ...
    public function upgrade(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '1.6.0', '<')) {
            $this->createStemmedWordsScheme->execute($setup);
        }
