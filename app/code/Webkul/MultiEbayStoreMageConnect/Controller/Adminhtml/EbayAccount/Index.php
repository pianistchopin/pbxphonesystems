...
class Index extends EbayAccount
{
    /**
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Webkul_MultiEbayStoreMageConnect::add_ebay_account');
        $resultPage->getConfig()->getTitle()->prepend(__('eBay Accounts'));
