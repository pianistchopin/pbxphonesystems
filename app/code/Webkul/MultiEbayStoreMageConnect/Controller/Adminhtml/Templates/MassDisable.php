...
class MassDisable extends Templates
{
    /**
     * Massactions filter.
     *
    ...
    public function execute()
    {
        ...
        foreach ($collection->getItems() as $template) {
            $template->setStatus(0)->setEntityId($template->getEntityId())->save();
            ++$templateCount;
        }
        $this->messageManager->addSuccess(__("A total of %1 record(s) have been disabled.", $templateCount));
